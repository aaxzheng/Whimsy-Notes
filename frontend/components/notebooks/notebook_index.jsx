...
class NotebookIndex extends React.Component {
  ...
  render() {
    ...
    const index = notebooks.map((notebook,idx) => {
      return (
        <NotebookIndexItem key={idx} notebook={notebook} openModal={this.props.openModal} fetchNotebook={this.props.fetchNotebook} fetchArray={this.props.fetchArray} deleteNotebook={this.props.deleteNotebook} />
      )
    });
    return(
        ...
        <div className="notebook-index">
          <div className="nb-index-top">
            ...
            <header className="nb-header">
              ...
              <button onClick={this.createModal} className="new-nb-btn">
            ...
            <div className="nb-index-items">
              ...
              <div className="nb-table">
                ...
                <div className="nb-index-list-items">
              {index}
                </div>
              </div>
            </div>
