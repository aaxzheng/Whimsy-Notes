...
class IndexItem extends React.Component {
  ...
  sendNotes() {
    this.props.fetchArray("notebook",this.props.notebook.id,this.props.notebook.title);
      ...
      <div className="nb-item">
        ...
        <div className="nb-item-title">
          <div className="nb-item-span">
            ...
            <span className="nb-item-name">
              ...
              <span className="nb-num">({this.props.notebook.note_ids.length})</span>
            </span>
          </div>
        </div>
        ...
        <div onFocus={this.dropdownReveal} tabIndex="0" onBlur={this.dropdownHide} className="nb-item-action">
          ...
          <div  className="nb-item-dropdown">
            <div id={this.props.notebook.id} ref={this.node}  className="nb-item-dropdown-body">
